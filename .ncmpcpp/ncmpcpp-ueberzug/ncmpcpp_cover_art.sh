...
fallback_image="/home/rashad/.ncmpcpp/fallback.png"
padding_top=0
padding_bottom=0
padding_right=0
max_width=33
...
# ==== Dunst notification & widget functions ======================================
display_notifications()
{
    song_name="$(mpc --format '%title%' current)"
    notify-send -i "$cover_path" "$b Now Playing ♫"  "$song_name"
    #/home/rashad/eww/target/release/eww update imgCover="$cover_path"
}
